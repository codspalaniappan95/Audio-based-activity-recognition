...
"""ltype=os.listdir("/home/pi/rpo/Audio-based-activity-recognition/data/Cropped_audio5/test")
leat=os.listdir("/home/pi/rpo/Audio-based-activity-recognition/data/Cropped_audio5/eat")
lhair=os.listdir("/home/pi/rpo/Audio-based-activity-recognition/data/Cropped_audio5/hair")
llaund=os.listdir("/home/pi/rpo/Audio-based-activity-recognition/data/Cropped_audio5/laund")
lvac=os.listdir("/home/pi/rpo/Audio-based-activity-recognition/data/Cropped_audio5/vac")
l=[ltype,leat,lhair,llaund,lvac]
v=30"""
